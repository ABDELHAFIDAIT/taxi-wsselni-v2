...
<body>
    ...
    <div class="content">
        <h2>Status de votre réservation</h2>
        
        <p>Bonjour {{ $passenger }},</p>
        
        <p>Malheuresement, Votre réservation a été refusée par le Chauffaur. Voici les détails de votre trajet :</p>
        ...
        <p>Vous pouvez réserver un autre taxi selon sa disponibilité et vos critères.</p>
    </div>
