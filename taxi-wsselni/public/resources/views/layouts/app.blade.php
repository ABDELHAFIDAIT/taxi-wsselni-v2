                            ...
                            <div class="flex flex-col h-0 flex-1 bg-white shadow">
                                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                                    <nav class="flex-1 px-2 space-y-2">
                                        ...
                                        <a href="{{ route('admin.passengers') }}" class="group flex items-center px-2 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md">
                                            <i class="fa-regular fa-bookmark mr-3"></i>
                                            Passagers
                                        </a>
                                        <a href="{{ route('admin.drivers') }}" class="group flex items-center px-2 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md">
                                            <i class="fas fa-route mr-3"></i>
                                            Chauffeurs
                                        </a>
                                        <a href="{{ route('admin.reactions') }}" class="group flex items-center px-2 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 rounded-md">
                                            <i class="fa-regular fa-calendar mr-3"></i>
                                            Réactions
                                        </a>
